...
describe("Desafios de Estruturas Condicionais.", () => {
  describe("01 - Testando a Função optionsMenu.", () => {
    it("Ao passar o argumento 1, deve retornar: '1 - Devs Lanche Feliz'", () => {
      expect(optionsMenu(1)).toBe("1 - Devs Lanche Feliz");
    });
    it("Ao passar o argumento 2, deve retornar: '2 - McDevs'", () => {
      expect(optionsMenu(2)).toBe("2 - McDevs");
    });
    it("Ao passar o argumento 3, deve retornar: '3 - DevsWooper'", () => {
      expect(optionsMenu(3)).toBe("3 - DevsWooper");
    });
    it("Ao passar o argumento 4, deve retornar: '4 - X-Devs'", () => {
      expect(optionsMenu(4)).toBe("4 - X-Devs");
    });
    it("Ao passar o argumento 5, deve retornar: '5 - Triplo Devs com JS'", () => {
      expect(optionsMenu(5)).toBe("5 - Triplo Devs com JS");
    });
  ...
  describe("03 - Testando a Função findAdventurous.", () => {
    ...
    it("Ao passar um argumento incorreto, deve retornar: 'Aventureiro não encontrado'", () => {
      expect(findAdventurous("Xablau")).toBe("Aventureiro não encontrado");
    });
  });
